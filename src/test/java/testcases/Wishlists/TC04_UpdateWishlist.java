...
import static model.UpdateWishlistBody.getUpdateWishlistBody;
import static util.Utility.NameGenerator.generateRandomName;

public class TC04_UpdateWishlist extends TestBase {

    @Test(priority = 1, description = "[4.3] check update wishlist positive flow")
    ...
    @Test(priority = 2, description = "[4.3] check update wishlist negative flow")
    public void checkUpdateWishlist_N() {
