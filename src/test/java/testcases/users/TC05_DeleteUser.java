...
public class TC05_DeleteUser extends TestBase {
    ...
    @Test(priority = 1, description = "[2.5] check delete user positive flow")
    public void checkDeleteUser_P() {
        // Send DELETE request
        Response response =
                given()
    ...
    @Test(priority = 2, description = "[2.5] check delete user negative flow")
    public void checkDeleteUser_N() {
